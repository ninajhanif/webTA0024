...
class Transaction extends Controller
{
    ...
    {
        $produk = $this->product_model->where('product_status', 'Active')->findAll();
        $data['produks'] = ['' => 'Pilih Produk'] + array_column($produk, 'product_name', 'product_id');
    ...
    public function store()
    {
        ...
        $data = array(
            ...
            'trx_price'          => $this->request->getPost('trx_price'),
            "trx_date"      => date('Y-m-d'),
        );
